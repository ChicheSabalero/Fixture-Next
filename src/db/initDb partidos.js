...
const main = async () => {
  ...
  INSERT INTO Partidos (Id, Fecha, ZonaL, Local, GolL, GolV, Visitante, ZonaV)
  VALUES
  ...
  INSERT INTO Partidos (Id, Fecha, ZonaL, Local, GolL, GolV, Visitante, ZonaV)
  VALUES
    ("039", 3, 'A', 'Estudiantes (BA)', 0, 0, 'Quilmes', 'A'),
    ("040", 3, 'B', 'Colon', 0, 0, 'Alte Brown', 'B'),
    ("041", 3, 'B', 'Estudiantes (RC)', 0, 0, 'Atlanta', 'B'),
    ("042", 3, 'B', 'Aldosivi', 0, 0, 'Def. Unidos', 'B'),
    ("043", 3, 'B', 'Mitre (SdE)', 0, 0, 'Dep. Madryn', 'B'),
    ("044", 3, 'B', 'Gimnasia (S)', 0, 0, 'Atl Rafaela', 'B'),
    ("045", 3, 'B', 'Gimnasia (M)', 0, 0, 'San Telmo', 'B'),
    ("046", 3, 'B', 'Nueva Chicago', 0, 0, 'Chaco For Ever', 'B'),
    ("047", 3, 'B', 'Dep. Moron', 0, 0, 'Def. de Belgrano', 'B'),
    ("048", 3, 'B', 'Temperley', 0, 0, 'Almagro', 'B'),
    ("049", 3, 'A', 'Tristan Suarez', 0, 0, 'Patronato', 'A'),
    ("050", 3, 'A', 'All Boys', 0, 0, 'Racing (C)', 'A'),
    ("051", 3, 'A', 'Agropecuario', 0, 0, 'Alvarado', 'A'),
    ("052", 3, 'A', 'Brown (PM)', 0, 0, 'Guemes (SdE)', 'A'),
    ("053", 3, 'A', 'San Martin (SJ)', 0, 0, 'Gimnasia (J)', 'A'),
    ("054", 3, 'A', 'Arsenal', 0, 0, 'Dep. Maipu', 'A'),
    ("055", 3, 'A', 'San Martin (T)', 0, 0, 'Ferro', 'A'),
    ("056", 3, 'A', 'Chacarita', 0, 0, 'San Miguel', 'A'),
    ("057", 3, 'A', 'Talleres (RdE)', 0, 0, 'Brown (A)', 'B');
  
  INSERT INTO Partidos (Id, Fecha, ZonaL, Local, GolL, GolV, Visitante, ZonaV)
  VALUES
    ('058', 4, 'A', 'Racing (C)', 0, 0, 'Tristan Suarez', 'A'),
    ('059', 4, 'B', 'Almagro', 0, 0, 'Brown (A)', 'B'),
    ('060', 4, 'B', 'Def. de Belgrano', 0, 0, 'Temperley', 'B'),
    ('061', 4, 'B', 'Chaco For Ever', 0, 0, 'Dep. Moron', 'B'),
    ('062', 4, 'B', 'San Telmo', 0, 0, 'Nueva Chicago', 'B'),
    ('063', 4, 'B', 'Atl Rafaela', 0, 0, 'Gimnasia (M)', 'B'),
    ('064', 4, 'B', 'Dep. Madryn', 0, 0, 'Gimnasia (S)', 'B'),
    ('065', 4, 'B', 'Def. Unidos', 0, 0, 'Mitre (SdE)', 'B'),
    ('066', 4, 'B', 'Atlanta', 0, 0, 'Aldosivi', 'B'),
    ('067', 4, 'B', 'Alte Brown', 0, 0, 'Estudiantes (RC)', 'B'),
    ('068', 4, 'A', 'Talleres (RdE)', 0, 0, 'Estudiantes (BA)', 'A'),
    ('069', 4, 'A', 'Quilmes', 0, 0, 'Chacarita', 'A'),
    ('070', 4, 'A', 'San Miguel', 0, 0, 'San Martin (T)', 'A'),
    ('071', 4, 'A', 'Ferro', 0, 0, 'Arsenal', 'A'),
    ('072', 4, 'A', 'Dep. Maipu', 0, 0, 'San Martin (SJ)', 'A'),
    ('073', 4, 'A', 'Gimnasia (J)', 0, 0, 'Brown (PM)', 'A'),
    ('074', 4, 'A', 'Guemes (SdE)', 0, 0, 'Agropecuario', 'A'),
    ('075', 4, 'A', 'Alvarado', 0, 0, 'All Boys', 'A'),
    ('076', 4, 'B', 'Colon', 0, 0, 'Patronato', 'A');
  
  INSERT INTO Partidos (Id, Fecha, ZonaL, Local, GolL, GolV, Visitante, ZonaV)
  VALUES
    ('077', 5, 'A', 'Chacarita', 0, 0, 'Talleres (RdE)', 'A'),
    ('078', 5, 'B', 'Estudiantes (RC)', 0, 0, 'Colon', 'B'),
    ('079', 5, 'B', 'Aldosivi', 0, 0, 'Alte Brown', 'B'),
    ('080', 5, 'B', 'Mitre (SdE)', 0, 0, 'Atlanta', 'B'),
    ('081', 5, 'B', 'Gimnasia (S)', 0, 0, 'Def. Unidos', 'B'),
    ('082', 5, 'B', 'Gimnasia (M)', 0, 0, 'Dep. Madryn', 'B'),
    ('083', 5, 'B', 'Nueva Chicago', 0, 0, 'Atl Rafaela', 'B'),
    ('084', 5, 'B', 'Dep. Moron', 0, 0, 'San Telmo', 'B'),
    ('085', 5, 'B', 'Temperley', 0, 0, 'Chaco For Ever', 'B'),
    ('086', 5, 'B', 'Brown (A)', 0, 0, 'Def. de Belgrano', 'B'),
    ('087', 5, 'A', 'Patronato', 0, 0, 'Racing (C)', 'A'),
    ('088', 5, 'A', 'Tristan Suarez', 0, 0, 'Alvarado', 'A'),
    ('089', 5, 'A', 'All Boys', 0, 0, 'Guemes (SdE)', 'A'),
    ('090', 5, 'A', 'Agropecuario', 0, 0, 'Gimnasia (J)', 'A'),
    ('091', 5, 'A', 'Brown (PM)', 0, 0, 'Dep. Maipu', 'A'),
    ('092', 5, 'A', 'San Martin (SJ)', 0, 0, 'Ferro', 'A'),
    ('093', 5, 'A', 'Arsenal', 0, 0, 'San Miguel', 'A'),
    ('094', 5, 'A', 'San Martin (T)', 0, 0, 'Quilmes', 'A'),
    ('095', 5, 'A', 'Estudiantes (BA)', 0, 0, 'Almagro', 'B');
  
  INSERT INTO Partidos (Id, Fecha, ZonaL, Local, GolL, GolV, Visitante, ZonaV)
  VALUES
    ('096', 6, 'A', 'Alvarado', 0, 0, 'Patronato', 'A'),
    ('097', 6, 'B', 'Def. de Belgrano', 0, 0, 'Almagro', 'B'),
    ('098', 6, 'B', 'Chaco For Ever', 0, 0, 'Brown (A)', 'B'),
    ('099', 6, 'B', 'San Telmo', 0, 0, 'Temperley', 'B'),
